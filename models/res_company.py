...
class ResCompany(models.Model):
    ...
    laba_rugi_report_id = fields.Many2one('account.financial.report', string='Laba/Rugi')
    add_space_level = fields.Boolean(string='Add space level between account', default=True)
